      ...
      <div class="auth-panel auth-panel--form">
        ...
        <div class="auth-card">
          <div class="auth-header">
            ...
            <p class="auth-desc">{{ t.auth.signUpDesc }}</p>
          </div>
          ...
          <form @submit.prevent="handleSignUp" class="auth-form">
            ...
            <div class="form-group">
              <label for="name">{{ t.auth.fullNameLabel }}</label>
            ...
            <div class="form-options">
              <label class="checkbox-container">
                ...
                <span class="checkbox-label">{{ t.auth.termsAgree }}</span>
              </label>
            </div>
          ...
          <p class="auth-switch">
            {{ t.auth.hasAccount }}
            <a href="#" @click.prevent="navigateTo('login')">{{ t.auth.loginNow }}</a>
          </p>
        </div>
      </div>
        ...
        <div class="google-modal">
          ...
          <div class="google-modal__body">
            ...
            <div v-else class="google-loading-state">
              ...
              <p>Creating account in Muscle Lab...</p>
            </div>
          </div>
...
function validateForm() {
  ...
  // Name check
  if (!form.name.trim()) {
    errors.name = t.value.auth.errorFields
    valid = false
  }
  ...
  if (form.password !== form.confirmPassword) {
    errors.confirmPassword = t.value.auth.errorPasswordMatch
    valid = false
  }
...
function handleSignUp() {
  ...
  setTimeout(() => {
    ...
    loading.value = false
    if (res.success) {
      successMsg.value = t.value.auth.successRegister
      setTimeout(() => {
        navigateTo('profile')
      }, 1000)
    } else {
...
.auth-panel--banner {
  flex: 1.2;
  position: relative;
  background: url('/banner_auth2.png') no-repeat center center;
